...
if __name__ == '__main__':
    ...
    if args.dataset=='cifar10':
        ...
        args.in_planes = 200
        args.input_size = 7
        print("| Preparing Indian Pines dataset...")

        trainset = Data.TensorDataset(x1_tensor_train, y1_tensor_train)
        testset = Data.TensorDataset(x1_tensor_test,y1_tensor_test)
        args.num_outputs = 16
